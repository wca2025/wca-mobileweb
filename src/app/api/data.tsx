...
export const CauseData: {
...
}[] = [
  {
    ...
    slug: "",
  text: "This initiative focuses on breaking down barriers to education for women and girls in marginalized communities. By providing access to quality learning resources, mentorship programs, and scholarships, it aims to foster leadership, economic independence, and social empowerment. The program also advocates for inclusive policies and safe learning environments to ensure long-term impact.",    raised: "$65,360",
    goal: "$124,500",
  },
  {
    ...
    slug: "",
  text: "This mission delivers essential healthcare services to populations with limited access to medical facilities. Volunteer doctors, nurses, and health workers provide checkups, vaccinations, maternal care, and health education. The program also supplies medical equipment and builds local capacity to ensure sustainable health outcomes in these remote areas.",    raised: "$65,360",
    goal: "$124,500",
  },
  {
    ...
    slug: "",
  text: "Dedicated to combating climate change, this project supports the development and implementation of renewable energy solutions such as solar, wind, and hydro power. It promotes eco-friendly practices, educates communities on energy conservation, and helps reduce reliance on fossil fuels. The initiative also partners with local governments and innovators to scale green technologies.",
    raised: "$65,360",
    goal: "$124,500",
  },
  {
    ...
    slug: "",
    text: "Supporting healthcare access for children in Africa.	",
    raised: "$65,360",
    goal: "$124,500",
  },
  {
    ...
    slug: "",
    text: "Bringing art supplies and joy to young children.	",
    raised: "$65,360",
    goal: "$124,500",
  },
  {
    ...
    slug: "",
    text: "Providing education for underprivileged children.		.",
    raised: "$65,360",
    goal: "$124,500",
  },
  {
    ...
    slug: "",
    text: "Promoting community health through outreach programs.	.",
    raised: "$65,360",
    goal: "$124,500",
  },
  {
    ...
    slug: "",
    text: "Fundraising through art to support school arts programs.",
    raised: "$65,360",
    goal: "$124,500",
  },

  {
    ...
    slug: "",
    text: "Supporting equal access to education through gala events.	",
    raised: "$65,360",
    goal: "$124,500",
  },
];
...
export const Eventdata: {
...
}[] = [
  {
    ...
    slug: "",
    text: "Eastlegon Adjiringanor Accra Ghana",
    date: "May 10, 2024",
    location: "San Marcos",
    type: "Open",
    entrants: "Unlimited",
